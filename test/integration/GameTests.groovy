class GameTests extends GroovyTestCase {
    ...
    void testAddNewTurn() {
        ...
        assertTrue("new game has turns", game.turns == null)
        game.addToTurns(new Turn(player: "A", row: 1, column: 1, turnNumber: game.lastTurnNumberMadeByPlayer("A") + 1))
        game.save(flush: true)
        ...
        game.addToTurns(new Turn(player: "A", row: 2, column: 1, turnNumber: game.lastTurnNumberMadeByPlayer("A") + 1))
        game.save(flush: true)
        ...
        game.addToTurns(new Turn(player: "B", row: 9, column: 9, turnNumber: game.lastTurnNumberMadeByPlayer("B") + 1))
        game.save(flush: true)
